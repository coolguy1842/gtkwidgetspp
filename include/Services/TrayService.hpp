...
protected:
    Glib::RefPtr<libdbusmenu::Menu> _menu;
...
public:
    ...
    Glib::RefPtr<libdbusmenu::Menu> getMenuModel();
    Glib::RefPtr<Gtk::PopoverMenu> getMenuWidget();

    void resetProperties();

    static void createForBus(Gio::DBus::BusType busType, Gio::DBus::ProxyFlags proxyFlags, const std::string& name, const std::string& objectPath, const Gio::SlotAsyncReady& slot, const Glib::RefPtr<Gio::Cancellable>& cancellable) {
        Gio::DBus::Proxy::create_for_bus(
            busType, name, objectPath, "org.kde.StatusNotifierItem", slot,
            cancellable, Glib::RefPtr<Gio::DBus::InterfaceInfo>(), proxyFlags
        );
    }
